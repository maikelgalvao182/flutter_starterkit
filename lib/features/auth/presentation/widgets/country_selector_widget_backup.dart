...
class _CountrySelectorWidgetState extends State<CountrySelectorWidget> {
  ...
  Future<void> _showCountryPicker() async {
    ...
    if (isoCode != null) {
      ...
      // Salva o nome completo do país (ex: "Brasil", "United States")
      // Usa o localization para pegar o nome traduzido
      final countryName = CountrySelectorLocalization.of(context)?.countryName(isoCode) ?? isoCode.name;
