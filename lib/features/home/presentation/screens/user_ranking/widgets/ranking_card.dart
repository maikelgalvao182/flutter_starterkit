...
/// Card de ranking inspirado no VendorCard
/// 
/// Layout: [#Posição] [Avatar] [Nome + JobTitle + Location] [Rating + Reviews]
class RankingCard extends StatelessWidget {
          ...
          child: Row(
            children: [
              ...
              StableAvatar(
                ...
                enableNavigation: false, // Navigation handled by card tap
              ),
              const SizedBox(width: 12),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Flexible(child: _buildLocation(context)),
                        if (entry.totalReviews > 0) ...[
                          const SizedBox(width: 8),
                          Text(
  ...
  /// Location com cidade e estado (reativo)
  Widget _buildLocation(BuildContext context) {
    return ReactiveVendorLocationSection(
      userId: entry.userId,
      distanceText: null,
      fontSize: 13,
    );
